...
public class GridMapRender {
	...
	public void draw(Canvas g) {
		//背景
		for (int y = 0; y < screenHeight/BG_HEIGHT+1; ++y) {
			for (int x = 0; x < screenWidth/BG_WIDTH+1; ++x) {
				g.drawBitmap(Constant.IMAGE_BG, x * BG_WIDTH, y * BG_HEIGHT, new Paint());
				//Log.d("draw:", x * BG_WIDTH+","+y * BG_HEIGHT);
			}
		}
